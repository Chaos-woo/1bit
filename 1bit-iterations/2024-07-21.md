...
- [x] 修改文字小站的将APP热搜仓库拆分为：今日热点/历史热搜/看点记录，并优化其UI展示

# 问题解决
- [x] GetX如何解决使用同一Controller类的页面重复进入，而不使用错误的Controller：https://github.com/jonataslaw/getx/issues/2787
  - 概述：使用tag区分初始化的Controller
- [X] 构建时Gradle JVM版本与Gradle版本不一致
  - stackoverflow：https://stackoverflow.com/questions/76123807/my-projects-gradle-version-is-incompatible-with-the-java-version-that-flutter-i
  - 问题原因：有时 Flutter 无法识别您的 Java 版本，而是使用与 Android Studio 捆绑的版本
  - 解决方法：在AS的控制台设置flutter以来的SDK版本：flutter config --jdk-dir /usr/lib/jvm/java-17-openjdk-amd64/
  - 其他：AS中的flutter项目，Gradle JVM最好设置和上面相同的JDK
  - 其他：JDK版本与Gradle版本映射关系：https://blog.csdn.net/Qhx20040819/article/details/131911031