...
part of "hot_search_group.dart";

@UseRowClass(HotSearchGroup)
class HotSearchGroups extends Table {
...
extension HotSearchGroupsDriftModelGeneratorExtension on HotSearchGroup {
  ...
  HotSearchGroupsCompanion toCompanion([Set<String> allowNulls = const {}]) {
