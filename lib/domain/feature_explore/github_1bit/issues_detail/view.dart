import 'package:cw2bit/domain/feature_explore/github_1bit/issues_detail/widgets/issues_comment_widget.dart';
import 'package:cw2bit/domain/feature_explore/github_1bit/issues_detail/widgets/issues_detail_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          GithubApiDataPostAction postResult = await rout0_.github_comment_edit.to_then_back();
