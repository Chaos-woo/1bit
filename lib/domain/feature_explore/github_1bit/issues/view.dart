import 'package:cw2bit/domain/feature_explore/github_1bit/issues/components/github_1bit_issues_list/view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          GithubApiDataPostAction back_action = await rout0_.github_issues_edit.to_then_back();
