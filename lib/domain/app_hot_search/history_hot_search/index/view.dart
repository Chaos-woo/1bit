            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    final _picked_date = await showDatePicker(
                      context: context,
                      initialDate: getCurrentTimestamp,
                      firstDate: (DateTime.fromMicrosecondsSinceEpoch(1688140800000000)),
                    ...
                    if (_picked_date != null) {
                      final picked_date = DateTime(
                        _picked_date.year,
                        _picked_date.month,
                        _picked_date.day,
                      );

                      /// TODO：选择时间后，直接切换到指定的历史归档
                    }
                  },
                  child: Container(
                    decoration: BoxDecoration(
                            ...
                            builder: (_) {
                              return ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  if (index == 0 && state.m_current_dir_path.split("/").length > 2) {
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        /// 跳转到上一页
                                        /// 计算当前路径的上一路径
                                        print('state.m_current_dir_path: ${state.m_current_dir_path}');
                                  ...
                                  if (GithubContentTypeEnum.dir == content.type) {
                                    return InkWell(
                                      splashColor: Colors.transparent,
                                      focusColor: Colors.transparent,
                                      hoverColor: Colors.transparent,
                                  ...
                                  } else if (GithubContentTypeEnum.file == content.type) {
                                    return InkWell(
                                      splashColor: Colors.transparent,
                                      focusColor: Colors.transparent,
                                      hoverColor: Colors.transparent,
