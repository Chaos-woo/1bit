...
class HotSearchArchive extends StatelessWidget {
  final Key list_view_key;

  const HotSearchArchive({super.key, required this.list_view_key});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: state.archived_webpages.isEmpty
          ? Center(
              child: Text('暂无 "归档" 的记录噢~',
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  for (final comb_webpage in state.archived_webpages) _widget_of_archive(context, comb_webpage),
