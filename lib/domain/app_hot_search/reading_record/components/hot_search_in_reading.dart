import 'package:cw2bit/domain/app_hot_search/reading_record/logic.dart';
...
class HotSearchInReading extends StatelessWidget {
  final Key list_view_key;

  HotSearchInReading({super.key, required this.list_view_key});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: state.in_reading_webpages.isEmpty
          ? Center(
              child: Text('暂无 "阅读中" 的记录噢~',
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  for (final comb_webpage in state.in_reading_webpages) _widget_of_reading(context, comb_webpage),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(
                            ...
                            color: q0_.bridge.flustars.text.isEmpty(comb_webpage.webpage_reading.article_analysis)
                                ? Colors.grey
