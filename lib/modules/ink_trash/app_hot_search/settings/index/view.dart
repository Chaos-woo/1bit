...
import 'package:cw2bit/modules/feature_explore/github_1bit/issues/components/github_setting/logic.dart';
import 'package:cw2bit/modules/app_homepage/my_home/components/tool_group/models/tool_group.dart';
import 'package:cw2bit/modules/app_homepage/my_home/components/tool_group/view.dart';
                ...
                toolGroup: ToolGroup(
                  ...
                  items: [
                    ToolGroupItemRouter(
                      ...
                      on_tap: () async {
                        rout0_.app_hot_search_settings_app_groups.to();
                      },
                    ),
                ...
                toolGroup: ToolGroup(
                  ...
                  items: [
                    ToolGroupItemRouter(
                      ...
                      on_tap: () async {
                        /// 跳转设置页为每个APP进行设置
                        await rout0_.app_reading_threshold_config.to();
                      },
                    ),
                    ToolGroupItemClicker(
                      title: '热搜阅读记录白名单',
