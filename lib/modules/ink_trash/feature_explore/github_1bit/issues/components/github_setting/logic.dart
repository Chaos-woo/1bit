...
final class _PathVariables {
  String? get show_1bit_repo => q0_.route.pathVariables(path_k_show_1bit_repo);
...
class GithubSettingLogic extends GetxController {
  ...
  void onInit() {
    ...
    String? access_token = q0_.bridge.flustars.preferences.getString(k_pfs_github_access_key);
